...
#load the digits' dataset. This dataset contains handwritten digits from 0 to 9.
import numpy as np
...
"""
We will first define our evaluation benchmark. During this benchmark, we intend to compare different 
initialization methods for KMeans. Our benchmark will:
...
Subsequently, we can use PCA to project into a 2-dimensional space and plot the data and the clusters 
in this new space.
"""
...
#[ : , 0 ] means (more or less) [ first_row:last_row , column_0 ]. If you have a 2-dimensional
#list/matrix/array, this notation will give you all the values in column 0 (from all rows).
